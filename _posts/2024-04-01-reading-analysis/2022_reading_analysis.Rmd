...
This graph is terrible. In essence, it shows the number of reading sessions per book. But it doesn't even list all of the book titles, and is very rudimentary. I'll be using `r ggplot2` to jazz it up a bit.
...
**Side note:** Did you know `r ggplot2` can make pie charts?? I didn't until I wanted to make this chart. See code below for how.
...
I wanted to make a version of this pie chart that includes interactive elements, which we can do using `r plotly`. I'll keep it simple here, and perhaps do a deeper dive of `r plotly` in a later post. 
