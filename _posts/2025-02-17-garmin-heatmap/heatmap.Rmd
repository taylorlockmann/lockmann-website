...
# Processing GPS data
Once I had an individual file for each activity (87 in total!), I had to aggregate it all into one file. I did this in a separate processing script, so that I could save one small, efficient file to this website and its associated GitHub repo. The code below will not run, it's just to showcase how I did this processing. Here is how to process raw Garmin GPX files into usable spatial data:
...
Once the data was in a workable format, I used `leaflet` to develop the following heatmap. Warmer colors indicate places where I've paddled more. Be sure to zoom in, as the map is interactive!
...
This was such a fun way to explore my paddling history and stats in 2024! Next, I’d love to explore integrating real-time water conditions. What other insights should I look for?
